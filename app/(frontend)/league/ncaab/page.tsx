// app/(frontend)/league/ncaab/page.tsx
import { prisma } from "@/lib/prisma";
import LeagueEventsNCAAB from "@/components/league/NcaabEvents";
...
export default async function NCAABLeaguePage() {
    ...
    <div className="w-full bg-[#FAFAFA] min-h-screen">
      <section className="w-full bg-[#FAFAFA] py-12 sm:py-16">
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          ...
          <LeagueEventsNCAAB events={events} />
        </div>
      </section>
    </div>
  );
