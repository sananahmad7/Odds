// components/league/LeagueEventsMLB.tsx
"use client";
...
} from "@/app/(frontend)/league/mlb/page";
...
/* ================= Component ================= */
export default function LeagueEventsMLB({ events }: Props) {
      ...
      <div className="mb-8 sm:mb-12 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        >
          <input
            ...
            className="w-60 font-neue sm:w-72 2xl:w-80 px-4 py-2 pl-10 text-[#111827] bg-white border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#24257C] focus:border-transparent transition-all duration-300"
          />
          <svg
